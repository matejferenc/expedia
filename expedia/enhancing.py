...
def run_solution():
    ...
    while 1:
        ...
        append_1 = ((book_year - 2012)*12 + book_month) *  (3 + 12*is_booking)
    ...
    while 1:
        ...
        if validate == 1:
            ...
            srch_destination_id = arr[16]
            if arr[5] == '':
                print('user location city empty {}'.format(user_location_city))
        else:
            user_location_city = int(arr[6])
            orig_destination_distance = arr[7]
            srch_destination_id = arr[17]

        if orig_destination_distance != '' and user_location_city != '' and srch_destination_id != '':
            distances[(user_location_city, srch_destination_id)] = orig_destination_distance
...
#     print(distances)
    ...
    while 1:
        ...
        if orig_destination_distance == '':
            if (user_location_city, srch_destination_id) in distances:
                orig_destination_distance = distances[(user_location_city, srch_destination_id)]
#                 print('found distance {}'.format(orig_destination_distance))
                distanceFound = True
    ...
    if validate == 1:
        ...
        print(" validation")
        print("----------------------------------------------------------------")
        print("position %8d %8d %8d %8d %8d %8s" % (1,2,3,4,5,"miss"))
